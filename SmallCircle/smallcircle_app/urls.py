...
from smallcircle_app import views
...
urlpatterns = [
	...
	#url(r'^category/(?P<category_name_slug>[\w\-]+)/add-media/$', views.add_media, name='add-media'),
	...
	#url(r'^auto_add_media/$', views.auto_add_media, name='auto_add_media'),
